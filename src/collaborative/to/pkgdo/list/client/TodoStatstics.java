...
public class TodoStatstics extends AnchorPane {
    ...
    private static Consumer<Itemstate> itemstateGUIGenerator;

    public static void setItemstateGUIGenerator(Consumer<Itemstate> itemstateGUIGenerator) {
    ...
    public TodoStatstics(ToDoEntity todo, int Percent) {
        ...
        this.setOnMousePressed((MouseEvent event) -> {
            ...
            List<Itemstate> items = FXMLController.statistics.setItemStates(todo);
